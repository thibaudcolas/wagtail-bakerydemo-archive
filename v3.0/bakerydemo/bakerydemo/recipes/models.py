...
class RecipePeopleRelationship(Orderable, models.Model):
    ...
    page = ParentalKey(
        "RecipePage",
        related_name="recipe_people_relationship",
        on_delete=models.CASCADE,
    )
    people = models.ForeignKey(
        "base.People",
        related_name="people_recipe_relationship",
        on_delete=models.CASCADE,
    )
...
class RecipePage(Page):
    ...
    def authors(self):
        ...
        """
        return People.objects.filter(live=True, People_recipe_relationship__page=self)
