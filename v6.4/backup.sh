...
rm -rf $SITE_NAME$ADMIN_PATH/pages/*/edit/preview/
...
rm -rf $SITE_NAME/static/django_extensions
rm $SITE_NAME/media/images/*.webp
rm $SITE_NAME/media/images/*.original.jpg
cp -R ../evergreen$ADMIN_PATH/api ./$SITE_NAME$ADMIN_PATH/api
cp -R ../evergreen$ADMIN_PATH/api ./$SITE_NAME$ADMIN_PATH/api

cp ../evergreen/_redirects ./$SITE_NAME/_redirects
